...
def Color():
    root.destroy()
    call(['python', 'C:/Users/Reemy/Documents/GitHub/std_googleAssistant/GUI/Codes/BabyG/colorGameBabyG.py'])

def TicTacToe():
    root.destroy()
    call(['python', 'C:/Users/Reemy/Documents/GitHub/std_googleAssistant/GUI/Codes/BabyG/tictactoeBabyG.py'])
