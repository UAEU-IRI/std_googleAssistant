...
class Piano:
    def __init__(self, master):
     ...
     self.label_1 = Label(frame, text="Calming Piano Music", bg="white", font=("Helvetica", 14))
     self.label_2 = Label(frame, text="Soft Piano Music", bg="white", font=("Helvetica", 14))
     self.label_3 = Label(frame, text="Rues Whistle Piano", bg="white", font=("Helvetica", 14))
...
root= Tk()
photo = PhotoImage(file="C:/Users/Reemy/Documents/GitHub/std_googleAssistant/GUI/Icons/Piano.png")
