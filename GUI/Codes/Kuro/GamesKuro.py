...
def Color():
 root.destroy()
 call(['python', '/home/pi/std_googleAssistant/GUI/Codes/Kuro/colorGameKuro.py'])

def TicTacToe():
 root.destroy()
 call(['python', '/home/pi/std_googleAssistant/GUI/Codes/Kuro/tictactoeKuro.py'])
...
root.title("Intelligent Fellow Kuro Games")
