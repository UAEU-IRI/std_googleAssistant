...
class GUI:
    def __init__(self, master):
     ...
     self.label_5 = Label(frame, text="Enter M/F", bg="white",fg="red", font=("Agency FB", 16))
     ...
     self.label_5.grid(row=3, column=2)
...
root= Tk()
photo = PhotoImage(file="/home/pi/std_googleAssistant/GUI/Icons/SignUp.png")
