...
class GUI:
    def __init__(self, master):
     ...
     self.label_1 = Label(frame, text="Rain", bg="white", font=("Helvetica", 14))
     self.label_2 = Label(frame, text="Thunderstorms", bg="white", font=("Helvetica", 14))
     self.label_3 = Label(frame, text="Ocean Waves", bg="white", font=("Helvetica", 14))
...
root= Tk()
photo = PhotoImage(file="/home/pi/std_googleAssistant/GUI/Icons/Relaxation1.png")
