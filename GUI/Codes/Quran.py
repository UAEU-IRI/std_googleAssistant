...
class GUI:
    def __init__(self, master):
     ...
     self.label_1 = Label(frame, text="سورة الفاتحة - مشاري العفاسي", bg="white", font=("Helvetica", 14))
     self.label_2 = Label(frame, text="سورة الإخلاص - مشاري العفاسي", bg="white", font=("Helvetica", 14))
     self.label_3 = Label(frame, text="سورة الفلق - مشاري العفاسي", bg="white", font=("Helvetica", 14))
     self.label_4 = Label(frame, text="سورة الناس - مشاري العفاسي", bg="white", font=("Helvetica", 14))
